    ...
    <section class="section">
        <div class="container">
            ...
            <div class="text-right mt-4">
                ...
                <a href="https://portaldocandidato.ifpr.edu.br/" target="_blank" class="btn btn-success">Inscrições
                    Abertas</a>
            </div>
        </div>
    </section>
                ...
                <div class="col-md-6 d-flex mb-4">
                    <div class="card testimonial-card">
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <footer class="text-right" style="font-style: italic;">
                                <?php echo $testimonial['student']; ?><br /><small><?php echo $testimonial['year']; ?></small>
                            </footer>
                        </div>
                    </div>
                </div>
